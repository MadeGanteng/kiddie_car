...
$id = $_GET['id'];
$query = $con->query(" SELECT * FROM ruang WHERE id_ruang ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-map ml-1 mr-1"></i> Edit Data Ruang</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nm_ruang" value="<?= $row['nm_ruang'] ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE ruang SET 
        nm_ruang = '$nm_ruang', 
        ket = '$ket'
        WHERE id_ruang = '$id'
    ");
