...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM kondisi a LEFT JOIN barang b ON a.id_barang = b.id_barang LEFT JOIN ruang c ON b.id_ruang = c.id_ruang WHERE id_kondisi ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-thermometer-half ml-1 mr-1"></i> Edit Data Kondisi Inventaris</h4>
                </div><!-- /.col -->
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE kondisi SET 
        id_barang = '$id_barang',
