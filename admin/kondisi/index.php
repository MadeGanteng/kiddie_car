                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM kondisi, barang, ruang where kondisi.id_barang = barang.id_barang AND ruang.id_ruang = barang.id_ruang ORDER BY kondisi.id_kondisi DESC");
