...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-thermometer-half ml-1 mr-1"></i> Tambah Data Kondisi Aset</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nm_ruang" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Kondisi Awal</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="kondisi" name="kondisi_awal" class="form-control" required readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Kondisi Sekarang</label>
                                    <div class="col-sm-10">
                                        <?= form_dropdown('cek_kondisi', $kon, '', 'class="form-control" required') ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Tanggal Cek</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="tgl_cek" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $data = $con->query("SELECT *, barang.id_barang AS ID_barang FROM barang, ruang where barang.id_ruang = ruang.id_ruang AND barang.musnah = 0 AND barang.kondisi != '' ORDER BY id_barang DESC");
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO kondisi VALUES (
        default, 
        '$id_barang', 
        '$kondisi_awal', 
        '$cek_kondisi', 
