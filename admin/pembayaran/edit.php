...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM pembayaran WHERE id_pembayaran ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-file-alt ml-1 mr-1"></i> Edit Data Pembayaran Pelanggan</h4>
                </div><!-- /.col -->
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE pembayaran SET 
        kode_trx = '$kode_trx',
        tgl_trx = '$tgl_trx'
