...
if (isset($_POST['cetak1'])) {
    ...
    $sql = mysqli_query($con, "SELECT * FROM berita_acara WHERE tanggal BETWEEN '$tgl1' AND '$tgl2' ORDER BY tanggal ASC");
    $label = 'LAPORAN DATA BERITA ACARA <br> Tanggal : ' . tgl($tgl1) . ' s/d ' . tgl($tgl2);
} else {
    $sql = mysqli_query($con, "SELECT * FROM berita_acara ORDER BY tanggal DESC");
    $label = 'LAPORAN DATA BERITA ACARA';
}
...
<head>
    <title>Laporan Data Berita Acara</title>
</head>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <table border="1" cellspacing="0" cellpadding="6" width="100%">
                                        ...
                                        <tbody>
                                            <?php $d = $con->query("SELECT * FROM sub_berita_acara a LEFT JOIN barang b ON a.id_barang = b.id_barang WHERE a.id_berita_acara = '$data[id_berita_acara]' ");
