...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM list_anggaran WHERE id_list_anggaran ='$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-file-alt ml-1 mr-1"></i> Edit Data List Anggaran</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_anggaran" value="<?= $row['nama_anggaran'] ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select  class="form-control" name="bulan" id="bulan" required>
                                            ...
                                            <option <?php if ($row['bulan'] == 'Januari') { echo 'selected'; }?> value="Januari">Januari</option>
                                            <option <?php if ($row['bulan'] == 'Februari') { echo 'selected'; }?> value="Februari">Februari</option>
                                            <option <?php if ($row['bulan'] == 'Maret') { echo 'selected'; }?> value="Maret">Maret</option>
                                            <option <?php if ($row['bulan'] == 'April') { echo 'selected'; }?> value="April">April</option>
                                            <option <?php if ($row['bulan'] == 'Mei') { echo 'selected'; }?> value="Mei">Mei</option>
                                            <option <?php if ($row['bulan'] == 'Juni') { echo 'selected'; }?> value="Juni">Juni</option>
                                            <option <?php if ($row['bulan'] == 'Juli') { echo 'selected'; }?> value="Juli">Juli</option>
                                            <option <?php if ($row['bulan'] == 'Agustus') { echo 'selected'; }?> value="Agustus">Agustus</option>
                                            <option <?php if ($row['bulan'] == 'September') { echo 'selected'; }?> value="September">September</option>
                                            <option <?php if ($row['bulan'] == 'Oktober') { echo 'selected'; }?> value="Oktober">Oktober</option>
                                            <option <?php if ($row['bulan'] == 'November') { echo 'selected'; }?> value="November">November</option>
                                            <option <?php if ($row['bulan'] == 'Desember') { echo 'selected'; }?> value="Desember">Desember</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tahun" value="<?= $row['tahun'] ?>" required>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form-tambah" method="POST" enctype="multipart/form-data" action="sub/simpan.php">
                    <div class="card-body">
                        <input type="hidden" name="id_list_anggaran" value="<?= $id ?>">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" onkeyup="findTotal()"  class="form-control" id="harga" name="harga" required>
                            </div>
                        </div>
                        <div class="form-group row">
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE list_anggaran SET 
        nama_anggaran = '$nama_anggaran',
        tgl_pengajuan = '$tgl_pengajuan',
        bulan = '$bulan',
        tahun = '$tahun'
        WHERE id_list_anggaran = '$id'
    ");
