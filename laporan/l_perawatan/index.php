            ...
            <div class="row">
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-6 text-right">
                    <a href="#" data-toggle="modal" data-target="#lap_perawatan" class="btn btn-sm bg-dark"><i class="fa fa-print"> Cetak</i></a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><?= $row['jenis_perawatan'] ?></td>
...
<div class="modal fade" id="lap_perawatan" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Laporan Data Perawatan Barang</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" target="_blank" action="<?= base_url('laporan/l_perawatan/cetak') ?>">
                ...
                <div class="col-md-12 text-center">
                    <a href="<?= base_url('laporan/l_perawatan/cetak') ?>" target="_blank" class="btn bg-purple btn-sm"><i class="fa fa-print"> </i> Cetak Semua </a>
                </div>
            </div>
        </div>
        <!-- /.modal-content -->
